...
void HAL_PWR_PVDCallback(void)
{
    ...
    {
        lcd_show_string(0, 80, 200, 16, 16, "PVD Low Voltage!",BLUE);  	/* The LCD displays low voltage */
        printf("PVD Low Voltage!\r\n");
    }
    else
    {
        lcd_show_string(0, 80, 200, 16, 16, "PVD Voltage OK! ",BLUE);  	/* The LCD voltage is normal */
