 ...
 * @file        lcd.c
 * @author      ALIENTEK
 * @brief       This file provides the driver for the lcd
...
void lcd_show_char(uint16_t x, uint16_t y, char chr, uint8_t size, uint8_t mode ,uint16_t color)
{
    ...
    {
        case 12:
            pfont = (uint8_t *)asc2_1206[chr];             /* 1206 font */
            break;

        case 16:
            pfont = (uint8_t *)asc2_1608[chr];             /* 1608 font */
            break;

        case 24:
            pfont = (uint8_t *)asc2_2412[chr];             /* 2412 font */
            break;

        case 32:
            pfont = (uint8_t *)asc2_3216[chr];             /* 3216 font */
            break;
