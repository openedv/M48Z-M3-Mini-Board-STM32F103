...
First select the model of the chip, here we use **STM32F103C8T6**, and then click the chip in ②, click Next to enter the next step. Next up is naming the project:
